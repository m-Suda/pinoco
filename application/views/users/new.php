...
<div class="page-content">
	<div class="row">
		...
		<div class="col-md-12">
			<div class="heading-large mb10">ユーザー新規作成</div>
		</div>
				...
				<form id="user_form_data">
					...
					<div class="name-area new-input-component">
						<div class="row">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" name="user_name" placeholder="名前">
							</div>
						</div>
                        <div class="row">
                            <div class="col-md-offset-6 col-md-6 mt10">
					...
					<div class="start-date-area new-input-component">
						<div class="row">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" name="start_date" placeholder="20xx0101">
							</div>
						</div>
                        <div class="row">
                            <div class="col-md-offset-6 col-md-6 mt10">
					...
					<div class="end-date-area new-input-component">
						<div class="row">
							...
							<div class="col-md-3">
								<input type="text" class="form-control" name="end_date" placeholder="20xx0101">
							</div>
						</div>
                        <div class="row">
                            <div class="col-md-offset-6 col-md-6 mt10">
