 ...
 *
 * Author: Michael Eisenbraun Version: 2.2.2 Requires: jQuery 1.7.2+
...
(function(e) {
    e.fn.columns = function(n) {
        ...
        typeof n == "string" ? this.each(function() {
            ...
            if (typeof t == "undefined" || !e.isFunction(t[n]))
                return e.error('No such method "' + n + '" for Columns');
            var s = t[n].apply(t, i);
            s !== undefined && s !== t && r.push(s)
        }) : this.each(function() {
            e.data(this, "columns") || e.data(this, "columns", new t(this, n))
        });
        return r.length === 0 ? this.data("columns") : r.length === 1 ? r[0]
                : r
    };
    var t = function(t, n) {
        this.$el = e(t);
        ...
        this.sort = function() {
            ...
            e.total && e.sortBy && typeof e.data[0][e.sortBy] != "undefined"
                    && e.data.sort(n(e.sortBy, e.reverse))
        };
                ...
                t.data = e.grep(t.data, function(e) {
                    for (var i = 0; i < n; i++)
                        if (typeof e[t.searchableFields[i]] == "string") {
                            if (e[t.searchableFields[i]].match(r))
                                return !0
                        } else if (typeof e[t.searchableFields[i]] == "number"
                                && e[t.searchableFields[i]] == t.query)
                            return !0;
                    return !1
                })
            }
        ...
        this.create = function() {
                ...
                e
                        .each(
                                ...
                                function(n, r) {
                                    if (!r.hide) {
                                        var i = {};
                                        e.inArray(r.key, t.sortableFields) === -1 ? i.notSortable = !0
                                                : t.sortBy === r.key ? t.reverse ? i.sortedDown = !0
                                                        : i.sortedUp = !0
                                                        : i.sortable = !0;
                                        i.key = r.key;
                                        i.header = r.header;
            ...
            function r(n, r) {
                var i = [];
                n % 2 === 0 ? i.push('<tr data-columns-row-id="' + n
                        + '" class="' + t.evenRowClass + '">') : i
                        .push('<tr data-columns-row-id="' + n + '" class="'
                                + t.oddRowClass + '">');
                e.each(t.schema, function(e, n) {
                    n.hide
                            || (n.template ? i.push("<td>"
                                    + t.chevron(n.template, r) + "</td>") : i
                                    .push("<td>" + r[n.key] + "</td>"))
                });
                i.push("</tr>");
                return i
            ...
            function s() {
                ...
                }) : t.rows.push('<tr class="' + t.evenRowClass
                        + '"><td colspan="' + t.schema.length
                        + '"><em>No Results</em></td>')
            }
            var t = this;
            t.resetData();
            ...
            e.extend(t.view, o);
            t.plugins
                    && e.each(t.plugins, function(e, n) {
                        typeof ColumnsPlugins != "undefined"
                                && typeof ColumnsPlugins[n] != "undefined"
                                && ColumnsPlugins[n].create.call(t)
                    });
            if (t.search) {
    ...
    t.prototype = {
        ...
        searchHandler : function(e) {
            this.liveSearch ? this.create() : e.keyCode == "13"
                    && this.create()
        },
        ...
        setRange : function() {
            var e = (this.page - 1) * this.size, t = e + this.size < this.total ? e
                    + this.size
                    : this.total;
            this.range = {
                start : e + 1,
        ...
        (
                ...
                function(e) {
                    ...
                    E.prototype.render = function(e, t, n) {
                        var r = this.parse(e), i = t instanceof w ? t
                                : new w(t);
