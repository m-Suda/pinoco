...
$('#create-user').click(function() {
	window.location.href = BASE_URL + "company/new";
});
...
$('.edit-btn').click(function() {
	...
	window.location.href = BASE_URL + "company/edit/" + id;
});
...
$('#delete-entry-modal').on('show.bs.modal', function(event) {
	...
	// モーダルにidを渡す
	$(this).find('#delete-company-id').val(id);
});
...
$('#start-delete').click(function() {
	...
	var id = $(this).parents().find('#delete-company-id').val();
